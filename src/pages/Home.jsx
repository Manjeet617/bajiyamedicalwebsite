...
export default function Home() {
  ...
  return (
    <section className="min-h-screen pt-20 pb-16 bg-teal-100 text-gray-800">
      <div className="bg-white bg-opacity-95 backdrop-blur-sm p-6 rounded-md shadow-lg mx-4 md:mx-8 lg:mx-16">
        {/* Welcome Message */}
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-bold text-teal-700">Welcome to Bajiya Medical</h2>
        </div>
        ...
        {/* Products Grid */}
        <h3 className="text-xl font-semibold mb-3 text-teal-600">Popular Medicines</h3>
        ...
        {/* Testimonials */}
        <h3 className="text-xl font-semibold mb-3 text-teal-600">What Our Customers Say</h3>
        <div className="space-y-4">
          {testimonials.map((t, i) => (
            <div key={i} className="bg-teal-50 p-4 rounded shadow">
              <p className="italic text-gray-700">"{t.feedback}"</p>
              <p className="mt-2 text-sm font-semibold text-right text-teal-800">- {t.name}</p>
            </div>
          ))}
        </div>
      </div>
